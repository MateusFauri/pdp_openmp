...
quantidades_pontos = [1000, 10000, 100000, 1000000, 5000000, 10000000]
...
print(
    f"Iniciando a geração dos arquivos TXT com pontos aleatórios (intervalo: [{min_coord}, {max_coord}])..."
)
